...
import FocusProtocolModal from './FocusProtocolModal';
    ...
    <div className="w-full h-full flex flex-col bg-transparent text-on-background font-sans selection:bg-primary/30 min-h-screen overflow-hidden relative">
      <div className="relative z-10 flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex items-center gap-6">
           ...
           <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-primary/30 flex items-center justify-center bg-black/5">
      ...
      <FocusProtocolModal 
        isOpen={workflowStatus === 'SELECTING'} 
