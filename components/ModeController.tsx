  ...
  return (
    <>
      ...
      <div className="relative w-full flex-1 flex flex-col min-h-0">
        ...
        {isMobile &&
          <>
            <div className="absolute top-20 left-8 z-50 flex items-center gap-3 bg-[#081425]/60 backdrop-blur-xl px-4 py-2 rounded-full border border-white/5 shadow-lg">

              <>
                <Smartphone className="w-3.5 h-3.5 text-[#00dbe9]" />
                <span className="text-[10px] font-display uppercase tracking-[0.2em] text-[#d8e3fb]/60 font-bold">Mobile Link</span>
